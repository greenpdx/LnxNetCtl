...
install -D -m 755 target/release/nccli "${BINDIR}/nccli"
...
if [ -d "docs" ]; then
    ...
    [ -f "docs/nccli.1" ] && install -D -m 644 docs/nccli.1 "${MAN1_DIR}/nccli.1"
...
print_info "  - nccli binary (${BINDIR}/nccli)"
